...
// from apple safari ios ...
// add  <body onorientationchange="updateOrientation();">
// because sometime windowResized() is call with wrong dimensions...
...
function windowResized() {
  ...
  backGroundColor.green = Math.random() * 100;
  backGroundColor.blue = Math.random() * 100;
}
